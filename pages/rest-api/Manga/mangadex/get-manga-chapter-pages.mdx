...
<Tabs items={["JavaScript", "Python"]}>
  <Tab>
    <>
        ...
        const url = "http://localhost:4000/manga/mangadex/read/5f7891b4-f048-4516-9c75-7bcd6dbd1451";
        const data = async () => {
            try {
  ...
  <Tab>
    <>
        ...
        # Using the example chapter ID of "5f7891b4-f048-4516-9c75-7bcd6dbd1451"
        url = "http://localhost:4000/manga/mangadex/read/5f7891b4-f048-4516-9c75-7bcd6dbd1451"
