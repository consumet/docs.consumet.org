...
<Tabs items={["JavaScript", "Python"]}>
  ...
  <Tab>
    <>
        ...
        # Using an example image URL (URL encoded).
        image_url = quote("https://mangareader.to/images/manga/12345/001.jpg", safe="")
        url = f"https://api.consumet.org/manga/mangareader/proxy?url={image_url}"
