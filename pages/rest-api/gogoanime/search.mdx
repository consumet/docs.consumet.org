...
| --------- | --------- | ----------------------------------------------------------------- | ------------ |
| query     | string    | The search query; i.e. the title of the item you are looking for. | `query = ""` |

## Query Parameters

| Parameter | Data Type | Description                           | Default    |
| --------- | --------- | ------------------------------------- | ---------- |
| page      | integer   | The page number of results to return. | `page = 1` |
...
<Tabs items={["JavaScript", "Python"]}>
  ...
  <Tab>
    <>
        ...
        # Using the example query "demon", and looking at the 2nd page of results.
        url = "https://api.consumet.org/anime/gogoanime/demon"
