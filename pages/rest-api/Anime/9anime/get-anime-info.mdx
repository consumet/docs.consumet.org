...
```
https://api.consumet.org/anime/9anime/info?id={id}
```
...
<Tabs items={["JavaScript", "Python"]}>
  <Tab>
    <>
        ...
        const url = "https://api.consumet.org/anime/9anime/info?id=spy-x-family.6ll19";
        const data = async () => {
            try {
  ...
  <Tab>
    <>
        ...
        # Using the example ID of "spy-x-family.6ll19".
        url = "https://api.consumet.org/anime/9anime/info?id=spy-x-family.6ll19"
        response = requests.get(url, params={"id": "spy-x-family.6ll19"})
        data = response.json()
