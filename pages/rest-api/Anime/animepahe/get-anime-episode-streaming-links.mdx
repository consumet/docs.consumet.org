...
<Tabs items={["JavaScript", "Python"]}>
  ...
  <Tab>
    <>
        ...
        Using the example episode ID of '2242c5d8ac108a8b5d0ac16bf2db82d55d5a578b2ed2e4ca0c6ed1b5dccc3e95"'
        """
        url = "https://api.consumet.org/anime/animepahe/watch"
        response = requests.get(url, params={"episodeId": "2242c5d8ac108a8b5d0ac16bf2db82d55d5a578b2ed2e4ca0c6ed1b5dccc3e95"})
        data = response.json()
