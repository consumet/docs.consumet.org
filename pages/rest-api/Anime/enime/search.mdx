...
```
https://api.consumet.org/anime/enime/{query}?page={number}
```
...
<Tabs items={["JavaScript", "Python"]}>
  <Tab>
    <>
        ...
        const url = "https://api.consumet.org/anime/enime/demon?page=2";
        const data = async () => {
            try {
  ...
  <Tab>
    <>
        ...
        # Using the example query "demon", and looking at the 2nd page of results.
        url = "https://api.consumet.org/anime/enime/demon"
